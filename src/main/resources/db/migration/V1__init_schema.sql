...
-- Pre-seed admin account with BCrypt hash of "admin123" (cost 10).
-- Generated via PasswordUtil.encode("admin123"). BCrypt salts each hash, so the literal value below
-- is one valid hash among many. Verify via PasswordUtil.matches("admin123", <hash>) after Task 22.
